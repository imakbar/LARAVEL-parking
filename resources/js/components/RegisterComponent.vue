						...
						<div class="row">
							<div class="col-md-12">
								<ul class="list-inline">
									...
									<li class="list-inline-item">
										<a class="btn bg-pink text-white text-bold-600 text-spacing-5 text-uppercase text-size-15 mb-10 rounded-0 box-shadow-1 pt-12 pb-12 pl-20 pr-20" href="/register">Register</a>
									</li>
									<li class="list-inline-item">
								...
								<div class="alert alert-dismissible fade show alert-danger" role="alert" v-if="dataerror">
									{{dataerror}}
									<button type="button" class="close" data-dismiss="alert" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
								</div>
								<div class="alert alert-dismissible fade show alert-success" role="alert" v-if="datasuccess">
									{{datasuccess}}
									<button type="button" class="close" data-dismiss="alert" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
								...
								<div class="tab-pane bg-white pt-30 pb-30 pl-30 pr-30 box-shadow-1 position-relative">
									...
									<h3 class="text-bold-700 text-uppercase mb-20">Register</h3>
									<form id="mainForm">
										...
										<!-- <vue-recaptcha sitekey="6Lf35hkUAAAAAHRbXTFyDwQw4y55Oy1ifsTiZ1fq"></vue-recaptcha>
											<small v-if="errors.g-recaptcha-response != null" class="text-danger text-size-11">
												<span>
										...
										<div class="row mt-30">
											<div class="col-md-6">
												<button class="btn btn-pink text-white rounded-0 text-bold-600 text-spacing-5 text-uppercase text-size-13 mb-10 pt-12 pb-12 pl-20 pr-20" @click.prevent="save()">Register</button>
											</div>
											<div class="col-md-6 text-right">
												<a class="text-pink" href="/login">Already have account?</a>
											</div>
										</div>
									</form>
								</div>
